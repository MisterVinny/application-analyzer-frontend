<template>
  <div class="profile">
    <div class="container-fluid bg-gray-300 p-0 m-0 vh-100">
      <!-- New Profile-->
      <div
        class="container bg-gray-300 pt-5 pb-5 d-flex justify-content-center"
      >
        <div
          class="
            bg-white
        ...
        >
          ...
          <div class="row g-4" v-if="editToggle === false">
              ...
              <div class="d-inline-grid gap-auto-3 text-gray-500">
                <div class="my-1 py-0">
                  <div class="form-floating mb-4">
                    ...
                    />
                    <label for="account_address" class="pr-0 mr-0"
          ...
          <div class="row g-4 justify-content-left">
            ...
            <div class="col-md-8 d-inline-grid gap-auto-3 pt-4" v-else>
              <button
                type="button"
                class="btn btn-outline-secondary btn-sm"
                v-on:click="toggleEdit()"
